...
def init_pygame_opengl(width=800, height=600, title="Lab02_04 - Moving Object"):
    pygame.init()
...
def main():
    ...
    while running:
        ...
        # simple animation left/right
        speed = 2.0
        obj_x += direction * speed * dt
        if obj_x > 3.0:
            obj_x = 3.0
            direction = -1
        elif obj_x < -3.0:
